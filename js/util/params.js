...
export const LEGEND_PARAMS = {TEXT_X: 260, TEXT_Y: 30};
export const PATH_PARAMS = {LEGEND_PATH: "M234 30, 250, 30"};
export const CIRCLE_PARAMS = {RADIUS: 6};
export const AXIS_PARAMS = {BUFFER_PERCENTAGE: 0.5};
